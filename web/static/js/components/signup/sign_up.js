      ...
      m(".pb-60", [
        ...
        m(".card-wrapper sign center-block p-all-side-75", [
          m("p", { class: "text-dark--grey mb-45" }, "Already a member. ", [
            m("a", { href: "/signin", oncreate: m.route.link, class: "btn-link" }, "Login!")
          ]),
          m("form", { class: "" }, [
            m(textField, {
              type: 'email',
            ...
            m(".magic-checkbox--big mt-55 has-error", [
              ...
              m("label", { for: "accept_terms_and_conditions", class: "weight-light" }, [
                ...
                m("p", {
                  class: "error-label " + (state.errors()['accept_terms_and_conditions'] ? "show" : "hidden")
                }, state.errors()['accept_terms_and_conditions'])
              ])
            ]),
  ...
  return {
    oninit(vnode){
      ...
      this.createUser = (args) => {
        return Registration.create(args).then(() => {
